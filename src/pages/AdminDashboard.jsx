                  ...
                  <div key={report.id} className="border dark:border-gray-700 rounded-lg p-4">
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-red-600 font-bold">ne report kiya → {report.reported_name || 'Unknown'} ({report.reported_email})</p>
                        </div>
                      </div>
                    ...
                    {report.status === 'pending' && (
                      <div className="flex gap-2 mt-4">
                        <button
                          onClick={() => handleReportAction(report.id, 'approve', report.reported_user_id, report.reported_name)}
                        ...
                        <button
                          onClick={() => handleReportAction(report.id, 'reject', report.reported_user_id, report.reported_name)}
                          disabled={actionLoading === report.id}
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 dark:text-white">
                          ...
                          {isAdminUser && <span className="ml-2 text-xs bg-purple-100 text-purple-700 px-2 py-0.5 rounded">ADMIN</span>}
                        </p>
